...
//           </div>
//           <ul className='text-white flex flex-col items-center  gap-2 mt-5 px-5 py-10 text-lg font-medium'>
//             <NavLink onClick={() => setShowMenu(false)} to='/'><p className='px-4 py-2 rounded hover:text-primary2 inline-block '>HOME</p></NavLink>
//             <NavLink onClick={() => setShowMenu(false)} to='/doctors'><p className='px-4 py-2 rounded hover:text-primary2 inline-block'>ALL DOCTORS</p></NavLink>
//             <NavLink onClick={() => setShowMenu(false)} to='/about'><p className='px-4 py-2 rounded hover:text-primary2 inline-block'>ABOUT</p></NavLink>
//             <NavLink onClick={() => setShowMenu(false)} to='/contact'><p className='px-4 py-2 rounded hover:text-primary2 inline-block'>CONTACT</p></NavLink>
//             {!token && (
//               <button
//                 onClick={() => {
//                   setShowMenu(false);
